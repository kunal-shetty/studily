...
<div class="container-narrow">
    <div class="page-head rise">
        <h1>⚙ Settings</h1>
        <p>Make Studily yours — appearance, AI model, and alerts.</p>
    </div>

    <form class="card rise rise-1" method="post" action="<%= ctx %>/settings">
        <div class="card-title"><span class="icon">🎨</span><h3>Appearance</h3></div>

        <div class="form-group">
            <label>Theme</label>
            <div class="choice-row">
                <label class="choice <%= "light".equals(settings.getTheme()) ? "" : "selected" %>">
                    <input type="radio" name="theme" value="dark" <%= "light".equals(settings.getTheme()) ? "" : "checked" %>>
                    <span>🌙 Dark</span>
                </label>
                <label class="choice <%= "light".equals(settings.getTheme()) ? "selected" : "" %>">
                    <input type="radio" name="theme" value="light" <%= "light".equals(settings.getTheme()) ? "checked" : "" %>>
                    <span>☀️ Light</span>
                </label>
            </div>
        </div>
        ...
        <div class="card-title mt-3"><span class="icon">🤖</span><h3>AI Model</h3></div>
        <div class="form-group">
        ...
        <div class="card-title mt-3"><span class="icon">🔔</span><h3>Notifications</h3></div>
        <div class="form-group">
...
<script>
    ...
    (function () {
        ...
        try { localStorage.setItem('studily-prefs', JSON.stringify(prefs)); } catch (e) { /* private mode */ }
    })();
</script>
